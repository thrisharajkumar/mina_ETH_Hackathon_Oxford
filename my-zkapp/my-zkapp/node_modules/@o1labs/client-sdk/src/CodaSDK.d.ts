...
/**
  ...
  */
export declare const signMessage: (_1: string, _2: keypair) => signed<string>;
/**
  ...
  */
export declare const verifyMessage: (_1: signed<string>) => boolean;
/**
  ...
  */
export declare const signPayment: (_1: payment, _2: keypair) => signed<payment>;
/**
  ...
  */
export declare const signStakeDelegation: (_1: stakeDelegation, _2: keypair) => signed<stakeDelegation>;
/**
